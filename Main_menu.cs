...
namespace Do_an_tot_nghiep
{
    public partial class Main_menu : Form
    {
        ...
        string strCon =@"Data Source=DESKTOP-FIJ9K34\SQLEXPRESS;Initial Catalog=DANG_NHAP;Integrated Security=True";
        public Main_menu()
        {
        ...
        private void btn_refreshdtgv_Click(object sender, EventArgs e)
        {
                        ...
                        if (dt0.Rows.Count > 0)
                        {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    string txtbs = System.IO.File.ReadAllText(duongdanbs + "\\" + rec + "txt" + ".txt");
                                    text_BiensoVAO.Text = txtbs;
                                    if (text_BiensoVAO.Text == text_BiensoRA.Text)
                                    {
                                        lbltrungBS.Text = "Trùng biển số";
                                        lbltrungBS.ForeColor = Color.Green;
                                    }
                                    else
                                    {
                                        lbltrungBS.Text = "Khác biển số";
                                        lbltrungBS.ForeColor = Color.Red;                                    
                                    }
                                    mode = false;
                                }
                                catch (Exception er)
